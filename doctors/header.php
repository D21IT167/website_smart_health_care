...
<div class="container-fluid">
		<div class="header_top">
			...
			<span style="font-size:50px;color:#2c2f84;font-weight:bolder;margin-left:15px;">Smart Health Care System</span>
		</div>
	...
	<div class="navbar navbar-default nav">
		<nav class="menu">
			<ul>
				...
				<li><a href="myCustomer.php">Patients Details</a></li>
